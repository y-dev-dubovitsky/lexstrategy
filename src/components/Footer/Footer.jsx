        ...
        <div className='py-16 border-b border-gray-800/50'>
          <div className='max-w-4xl mx-auto text-center'>
            ...
            <p className='text-lg text-gray-300 mb-8 max-w-2xl mx-auto'>
              Запланируйте стратегическую сессию с нашими экспертами и получите
              дорожную карту трансформации вашего бизнеса
            </p>

            <div className='flex flex-col sm:flex-row gap-4 justify-center'>
              <button
                onClick={() => scrollToSection('contact')}
                className='group relative bg-gradient-to-r from-emerald-600 to-cyan-600 hover:from-emerald-500 hover:to-cyan-500 font-semibold py-4 px-8 rounded-xl transition-all duration-500 transform hover:scale-[1.02] shadow-lg hover:shadow-emerald-500/25'
              >
              ...
              <button onClick={() => scrollToSection('contact')} className='group relative bg-gray-900/50 hover:bg-gray-800/50 border border-gray-800/50 font-semibold py-4 px-8 rounded-xl transition-all duration-500 transform hover:scale-[1.02] backdrop-blur-sm'>
        ...
        <div className='py-16 grid grid-cols-1 lg:grid-cols-4 gap-12'>
          ...
          <div className='lg:col-span-2'>
            ...
            <p className='text-gray-300 mb-6 leading-relaxed'>
              Мы трансформируем юридические вызовы в стратегические возможности.
              Наша миссия — построить для каждого клиента правовой фундамент
              будущего успеха через инновационные решения и экспертизу высшего
              уровня.
            </p>
                ...
                return (
                  ...
                  >
                    <div className='flex items-start space-x-3'>
                      <div
                        className={`p-2 bg-${contact.color}-500/10 border border-${contact.color}-500/20 rounded-lg`}
                      >
          ...
          <div className='flex flex-col lg:flex-row justify-between items-center'>
            ...
            <div className='flex items-center space-x-6'>
              <div className='text-sm text-gray-400'>
                <span className='text-emerald-400 font-medium'>ISO 27001</span>{' '}
                Certified
              </div>
              <div className='text-sm text-gray-400'>
