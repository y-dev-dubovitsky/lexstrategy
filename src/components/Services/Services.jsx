...
const Services = () => {
  ...
  const legalServices = [
    {
      ...
      description: "Комплексное юридическое сопровождение бизнеса и стратегические консультации",
    ...
    },
    {
      id: 1,
      title: "M&A и сделки",
      description: "Сопровождение сделок по слияниям и поглощениям, due diligence",
      icon: BriefcaseIcon,
      color: "cyan",
      particles: 18,
      size: "md",
    ...
    },
    {
      id: 4,
      title: "Банкротство",
      description: "Сопровождение процедур банкротства для кредиторов и должников",
      icon: UserGroupIcon,
      color: "rose",
      particles: 26,
      size: "sm",
  ...
  const serviceDetails = [
    {
      ...
      description: "Обеспечиваем полное юридическое сопровождение бизнеса: от регистрации компаний до сложных корпоративных процедур. Разрабатываем внутренние документы, проводим собрания участников, помогаем в реорганизации и ликвидации компаний.",
      features: [
      ...
      technologies: ["Due Diligence", "Корпоративное право", "Регистрация", "Лицензирование"]
    },
    {
      id: 1,
      title: "M&A и сделки",
      tagline: "Стратегические сделки под ключ",
      description: "Профессиональное сопровождение сделок по слияниям и поглощениям. Проводим комплексную юридическую экспертизу, готовим документы для сделок любой сложности, обеспечиваем юридическую чистоту на всех этапах.",
      features: [
    ...
    },
    {
      ...
      description: "Представляем интересы компаний в спорах с налоговыми органами. Помогаем оспорить доначисления, защищаем от необоснованных претензий, выстраиваем налоговую стратегию для минимизации рисков.",
      features: [
        "Налоговые проверки",
      ...
      technologies: ["Налоговое право", "Судебные споры", "Аудит", "Консультации"]
    },
    {
      id: 3,
      title: "Арбитражные споры",
      tagline: "Победная стратегия в суде",
      description: "Представление интересов в арбитражных судах всех инстанций. Разрабатываем стратегию ведения дела, готовим процессуальные документы, обеспечиваем защиту интересов на всех стадиях процесса.",
      features: [
      ...
      technologies: ["Арбитраж", "Исполнительное производство", "Апелляция", "Кассация"]
    },
    {
      id: 4,
      title: "Банкротство",
      tagline: "Защита активов и интересов",
      description: "Комплексное сопровождение процедур банкротства. Помогаем кредиторам вернуть долги, а должникам - пройти процедуру с минимальными потерями. Защищаем активы и обеспечиваем законность процедуры.",
      features: [
      ...
      technologies: ["Банкротство", "Финансовое право", "Взыскание долгов", "Санация"]
    },
    {
      id: 5,
      title: "Недвижимость",
      tagline: "Безопасные сделки с недвижимостью",
      description: "Юридическое сопровождение сделок с коммерческой и жилой недвижимостью. Проводим проверку объектов, готовим договоры, регистрируем права, защищаем от мошенничества.",
      features: [
      ...
      technologies: ["Недвижимость", "Регистрация", "Договоры", "Судебные споры"]
    }
  ];
  ...
  const getBgColorClass = (color) => {
    ...
    return colorMap[color] || 'bg-gradient-to-br from-emerald-500/10 to-emerald-500/5';
  };
  ...
  return (
    <section ref={containerRef} id="services" className="relative min-h-screen py-24 lg:py-32 bg-black overflow-hidden">
      {/* Фон с юридической тематикой */}
      <div className="absolute inset-0 bg-gradient-to-br from-gray-900 via-black to-gray-900">
        {/* Геометрический паттерн */}
        <svg className="absolute inset-0 w-full h-full opacity-5" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <pattern id="legal-grid" width="120" height="120" patternUnits="userSpaceOnUse">
              <path d="M 120 0 L 0 0 0 120" fill="none" stroke="#10b981" strokeWidth="1" />
              <circle cx="60" cy="60" r="4" fill="#10b981" opacity="0.3" />
              <path d="M 60 0 L 60 120" stroke="#3b82f6" strokeWidth="0.5" opacity="0.2" />
              <path d="M 0 60 L 120 60" stroke="#3b82f6" strokeWidth="0.5" opacity="0.2" />
            </pattern>
          </defs>
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        <div className={`text-center mb-16 lg:mb-24 transition-all duration-1000 transform ${
          ...
          <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto leading-relaxed font-light">
            Комплексные правовые решения для бизнеса и частных лиц. От простых консультаций до сложных судебных споров.
          </p>
        </div>

        {/* Статистика */}
        <div className={`grid grid-cols-2 lg:grid-cols-4 gap-6 mb-16 transition-all duration-1000 delay-300 transform ${
          isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
        }`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-16">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              ...
              <div className="relative w-full h-full perspective-1000">
                <div 
                  ...
                  style={{
                    transform: `translate(-50%, -50%) rotateX(${rotation / 3}deg) rotateY(${rotation}deg)`,
                      ...
                      >
                        ...
                        >
                          ...
                          <div className={`relative w-24 h-24 ${
                            service.size === 'lg' ? 'w-28 h-28' :
                            service.size === 'sm' ? 'w-20 h-20' : ''
                          }`}>
                            {/* Основной элемент */}
                            <div className={`absolute inset-0 bg-gradient-to-br from-gray-500/20 to-gray-500/10 border border-gray-500/30 rounded-full backdrop-blur-sm transition-all duration-500 ${
                              isActive ? 'scale-110' : ''
                            }`}></div>
                            
                            {/* Частицы - символы закона */}
                            {Array.from({ length: service.particles }).map((_, i) => {
                              const angle = (i / service.particles) * 2 * Math.PI;
                              ...
                              return (
                                <div
                                  key={i}
                                  className={`absolute w-2 h-2 bg-gradient-to-r ${getColorGradientClass(service.color)} ${getToColorGradientClass(service.color)} rounded-full transition-all duration-500`}
                                  style={{
                                    left: '50%',
                                    top: '50%',
                            ...
                            <div className={`absolute inset-0 flex items-center justify-center transition-all duration-500 ${
                              ...
                              <Icon className={`h-8 w-8 ${colorClass} group-hover:scale-110 transition-transform`} />
                            </div>
                          </div>

                          {/* Подпись услуги */}
                          <div className={`absolute left-1/2 -translate-x-1/2 top-full mt-4 whitespace-nowrap transition-all duration-500 ${
          ...
          <div className={`space-y-6 transition-all duration-1000 delay-300 transform ${
            ...
            {currentService && currentDetails && (
              <div className="bg-gradient-to-b from-gray-900/50 to-gray-900/30 backdrop-blur-sm rounded-3xl border border-gray-800/50 p-6 lg:p-8">
                <div className="flex items-center space-x-3 mb-6">
                  <div className={`p-3 ${getBgColorClass(currentService.color)} border ${getBorderColorClass(currentService.color)} rounded-xl`}>
                    {currentService.icon && (
                      <currentService.icon className={`h-6 w-6 ${getColorClass(currentService.color)}`} />
                    )}
                  </div>
                  <div>
                    ...
                    <div className={`text-sm ${getColorClass(currentService.color)}`}>
                ...
                <div className="mb-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {currentDetails.technologies.map((tech, index) => (
                      <span
                        key={index}
                        className={`px-3 py-1 text-sm ${getBgColorClass(currentService.color)} border ${getBorderColorClass(currentService.color)} ${getColorClass(currentService.color)} rounded-lg`}
                      >
                        {tech}
                      </span>
                    ))}
                ...
                <div className="space-y-3 mb-6">
                  ...
                  {currentDetails.features.map((feature, index) => (
                    <div key={index} className="flex items-center text-gray-300">
                      <div className={`w-2 h-2 bg-gradient-to-r ${getColorGradientClass(currentService.color)} ${getToColorGradientClass(currentService.color)} rounded-full mr-3`}></div>
                      {feature}
                    </div>
                  ))}
                </div>
                ...
                <div className="grid grid-cols-3 gap-4">
                  {currentDetails.stats.map((stat, index) => (
                    <div key={index} className="text-center">
                      <div className={`text-2xl font-bold ${getColorClass(currentService.color)} mb-1`}>
                        {stat.value}
                      </div>
            ...
            {/* CTA - Консультация */}
            <button className="w-full group relative bg-gradient-to-r from-emerald-600 to-cyan-600 hover:from-emerald-500 hover:to-cyan-500 font-semibold py-4 px-8 rounded-xl transition-all duration-500 transform hover:scale-[1.02] shadow-lg hover:shadow-emerald-500/25">
        ...
        <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-16 lg:mt-24 transition-all duration-1000 delay-500 transform ${
          isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
        }`}>
          {[
            { icon: BoltIcon, title: "Скорость", desc: "Срочные консультации за 1 час", color: "emerald" },
            { icon: ShieldCheckIcon, title: "Гарантия", desc: "Фиксированная стоимость услуг", color: "cyan" },
            { icon: ChartBarSquareIcon, title: "Опыт", desc: "15+ лет на юридическом рынке", color: "violet" },
            { icon: ArrowPathIcon, title: "Подход", desc: "Индивидуальная стратегия для каждого клиента", color: "amber" }
          ].map((item, index) => {
            ...
            return (
              ...
              >
                <div className={`p-3 ${bgClass} border ${borderClass} rounded-lg mb-4 group-hover:scale-110 transition-transform`}>
                  <Icon className={`h-6 w-6 ${colorClass}`} />
                </div>
                <div className="text-lg font-semibold text-white mb-2">{item.title}</div>
                <div className="text-sm text-gray-400">{item.desc}</div>
                <div className={`mt-4 w-0 h-0.5 bg-gradient-to-r ${gradientFrom} ${gradientTo} group-hover:w-full transition-all duration-500`}></div>
              </div>
            );
          })}
        </div>
        ...
        {/* Финальный CTA */}
        <div className={`text-center mt-16 lg:mt-24 transition-all duration-1000 delay-700 transform ${
          isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
        }`}>
