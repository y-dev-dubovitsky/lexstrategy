...
const Team = () => {
  ...
  const achievements = [
    ...
    { icon: BuildingOfficeIcon, value: "200+", label: "Клиентов", color: "cyan" },
    { icon: ChartBarIcon, value: "95%", label: "Успешных кейсов", color: "violet" },
    { icon: ArrowTrendingUpIcon, value: "×3", label: "Рост портфеля", color: "amber" }
  ];

  const principles = [
    { icon: LightBulbIcon, title: "Инновации", desc: "Внедряем передовые legal-tech решения" },
    { icon: ShieldCheckIcon, title: "Надежность", desc: "Гарантия результата и конфиденциальности" },
    { icon: HandThumbUpIcon, title: "Партнерство", desc: "Становимся частью команды клиента" }
  ];
  ...
  return (
    <section id="ceo" className="relative py-24 lg:py-32 bg-black overflow-hidden">
      {/* Фоновые элементы */}
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-40 -left-40 w-[800px] h-[800px] bg-cyan-500/3 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
        <div className="absolute top-1/3 left-1/4 w-[600px] h-[600px] bg-violet-500/2 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
        
        {/* Геометрические линии */}
        <svg className="absolute inset-0 w-full h-full opacity-5" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <pattern id="ceo-grid" width="120" height="120" patternUnits="userSpaceOnUse">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        <div className={`text-center mb-16 lg:mb-24 transition-all duration-1000 transform ${
          ...
          <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-emerald-500/10 to-cyan-500/10 border border-emerald-500/20 rounded-full px-6 py-3 mb-8">
            <SparklesIcon className="h-5 w-5 text-emerald-400 animate-spin" style={{ animationDuration: '3s' }} />
                  ...
                  <div className="bg-gradient-to-b from-gray-900/80 to-gray-900/90 backdrop-blur-md rounded-2xl p-6 border border-gray-800/50">
                    <div className="flex items-start justify-between">
                      ...
                      <div className="hidden lg:block">
                        ...
                        <div className="text-sm text-gray-400 mt-1">Рейтинг Forbes</div>
                      </div>
                    </div>
                    ...
                    <div className="mt-4 flex items-center space-x-4">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-sm text-gray-300">Основана в 2012</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <TrophyIcon className="h-5 w-5 text-emerald-400" />
                        <span className="text-sm text-gray-300">Топ-10 Legal Tech</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              {achievements.map((achievement, index) => (
                ...
                >
                  <div className="flex items-center space-x-3">
                    <div className={`p-2 bg-gradient-to-br from-${achievement.color}-500/10 to-${achievement.color}-500/5 border border-${achievement.color}-500/20 rounded-lg`}>
                      <achievement.icon className={`h-5 w-5 text-${achievement.color}-400`} />
                    </div>
                    <div>
                      <div className={`text-2xl font-bold text-${achievement.color}-400`}>{achievement.value}</div>
          ...
          <div className={`space-y-8 transition-all duration-1000 delay-500 transform ${
              ...
              <div className="bg-gradient-to-b from-gray-900/50 to-gray-900/30 backdrop-blur-sm rounded-3xl border border-gray-800/50 p-6 lg:p-8">
                  ...
                  {quotes.map((quote, index) => (
                    ...
                    >
                      <blockquote className="relative">
                        <div className="text-5xl lg:text-6xl text-emerald-500/20 font-serif absolute -top-6 -left-2">"</div>
                        ...
                        <div className="text-5xl lg:text-6xl text-cyan-500/20 font-serif absolute -bottom-6 -right-2 transform rotate-180">"</div>
                      </blockquote>

                      <div className="mt-8 flex items-center justify-between">
                        <div>
                          <div className={`text-3xl font-bold bg-gradient-to-r from-${index === 0 ? 'emerald' : index === 1 ? 'cyan' : 'violet'}-400 to-${index === 0 ? 'cyan' : index === 1 ? 'violet' : 'amber'}-400 bg-clip-text text-transparent`}>
                            {quote.stat}
                          </div>
                          <div className="text-sm text-gray-400">{quote.label}</div>
                        </div>
                        <div className="text-right">
                          <div className="text-sm text-gray-500">Цитата {index + 1}/{quotes.length}</div>
                        </div>
                      </div>
                    </div>
                  ))}
                ...
                <div className="flex items-center justify-between mt-6 pt-6 border-t border-gray-800/50">
                  ...
                  <div className="flex space-x-2">
                    ...
                    >
                      <svg className="h-5 w-5 text-gray-400 group-hover:text-emerald-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <button
                      ...
                      className="p-2 bg-gray-900/50 hover:bg-gray-800/50 border border-gray-800/50 rounded-lg transition-colors group"
                    >
                      <svg className="h-5 w-5 text-gray-400 group-hover:text-cyan-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="bg-gradient-to-r from-emerald-500/10 via-cyan-500/10 to-violet-500/10 backdrop-blur-sm rounded-3xl border border-gray-800/50 p-6 lg:p-8">
              <div className="flex items-center justify-between">
                ...
                <button className="px-6 py-3 bg-gradient-to-r from-emerald-600 to-cyan-600 hover:from-emerald-500 hover:to-cyan-500 rounded-xl font-semibold text-white transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-emerald-500/25">
                  Записаться
                </button>
              </div>
            </div>
        ...
        {/* Миссия компании */}
        <div className={`mt-20 lg:mt-24 text-center transition-all duration-1000 delay-700 transform ${
          isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
        }`}>
          ...
          <h3 className="text-3xl lg:text-4xl font-bold text-white mb-6 max-w-4xl mx-auto">
            ...
            <span className="text-emerald-400"> а открывают новые возможности</span>"
          </h3>
